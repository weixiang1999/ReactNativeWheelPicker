...
export default class TimePicker extends React.Component {
    ...
    render() {
        ...
        {...this.props} data={hours} onItemSelected={this.onHourSelected} selectedItem={selectedHourIndex} initPosition={selectedHourIndex}/>
        <WheelPicker 
        // style={styles.wheelPicker}
        isCyclic {...this.props} data={minutes} onItemSelected={this.onMinuteSelected} selectedItem={selectedMinuteIndex} initPosition={selectedMinuteIndex}/>
    ...
    renderAm() {
        ...
        return (<WheelPicker style={styles.wheelPicker} {...this.props} data={getAmArray()} onItemSelected={this.onAmSelected} selectedItem={selectedAmIndex} initPosition={selectedAmIndex}/>);
    }
